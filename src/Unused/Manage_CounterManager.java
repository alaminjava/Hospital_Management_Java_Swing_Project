 ...
 * @author APCL-LAB-1
 */
public class Manage_CounterManager extends javax.swing.JFrame {

    /**
     * Creates new form Add_CounterManager
     */
    public Manage_CounterManager() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage Counter Manager");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manage_CounterManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Manage_CounterManager().setVisible(true);
            }
        });
    }
