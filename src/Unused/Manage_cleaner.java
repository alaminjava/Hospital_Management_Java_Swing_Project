 ...
 * @author APCL-LAB-1
 */
public class Manage_cleaner extends javax.swing.JFrame {

    /**
     * Creates new form Add_cleaner
     */
    public Manage_cleaner() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manage_cleaner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Manage_cleaner().setVisible(true);
            }
        });
    }
