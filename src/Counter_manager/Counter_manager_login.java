 ...
 * @author APCL-LAB-1
 */
public class Counter_manager_login extends javax.swing.JFrame {

    /**
     * Creates new form Counter_manager_login
     */
    public Counter_manager_login() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Counter Manager Login");
    ...
    public boolean checklogin() {
        ...
        try {
            ...
            String query = "SELECT * FROM users WHERE Username=? AND Password=? AND UserType='Counter Manager' ";
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        // TODO add your handling code here:
        if (checklogin() == true) {
            Counter_manager_pannel patientform = new Counter_manager_pannel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Counter_manager_login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Counter_manager_login().setVisible(true);
            }
        });
    }
