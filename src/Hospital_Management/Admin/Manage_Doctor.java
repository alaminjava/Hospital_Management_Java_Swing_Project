 ...
 * @author APCL-LAB-1
 */
public class Manage_Doctor extends javax.swing.JFrame {

    /**
     * Creates new form Doctor_Pannel
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage Doctor's");
    ...
    private void backMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_backMouseClicked
        ...
        Admin_Pannel login = new Admin_Pannel();
    ...
    private void jPanel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel2MouseClicked
        // TODO add your handling code here:
        Add_Doctor_Form go = new Add_Doctor_Form();
        go.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Manage_Doctor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Manage_Doctor().setVisible(true);
            }
        });
    }
