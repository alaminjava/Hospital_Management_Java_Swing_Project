 ...
 * @author APCL-LAB-1
 */
public class Reciptionist_login extends javax.swing.JFrame {

    /**
     * Creates new form Reciptionist_login
     */
    public Reciptionist_login() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Reciptionist Login");
...
dbconnection dbcon = null;
    public boolean checklogin() {
        ...
        try {
            ...
            String query = "SELECT * FROM users WHERE Username=? AND Password=? AND UserType='Receiptionist' ";
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        // TODO add your handling code here:
        if (checklogin()==true) {
            Receiptionist_Pannel gopannel = new Receiptionist_Pannel();
            gopannel.setVisible(true);
            dispose();
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reciptionist_login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Reciptionist_login().setVisible(true);
            }
        });
    }
